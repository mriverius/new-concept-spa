...
export default function Contacto() {
  return (
    <section id="contacto" className="py-24 lg:py-32 px-6 sm:px-8 lg:px-12 bg-[#E8E4DD]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-8">
            <div className="bg-[#DCD7CE] p-8 rounded-lg transition-all duration-300 hover:bg-[#D0CABB] border border-gray-400">
